...
class DBUtils {
	...
	*/
	public static function getSequenceValue($sequence_name) {
	...
	/**
		...
		@param $emptyOption Provide an empty option at the top of the list
		@return A String that contains a HTML formated select field
	*/
	public static function arraySelect( $arr, $select_name, $select_attribs, $selected, $emptyOption = false ) {
		echo "</pre>";
		$s = "<select class=\"field_listbox\" id=\"$select_name\" name=\"$select_name\" $select_attribs>\n";
		if ($emptyOption)
		{
	...
	*/
	public static function createList( $rc, $id, $name ) {
		$list = array();
	...
	*/
	public static function checkResult($rc, $smsg=NULL, $fmsg=NULL, $sql) {
