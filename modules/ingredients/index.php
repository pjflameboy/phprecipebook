...
<?php
$sql_count = "SELECT count(*) FROM $db_table_ingredients WHERE ingredient_user = '" . $DB_LINK->addq($SMObj->getUserID(), get_magic_quotes_gpc()) ."' AND ingredient_name LIKE '". $DB_LINK->addq($where, get_magic_quotes_gpc()) ."%'";
$sql = "SELECT ingredient_id,ingredient_name FROM $db_table_ingredients WHERE ingredient_user = '" . $DB_LINK->addq($SMObj->getUserID(), get_magic_quotes_gpc()) ."' AND ingredient_name LIKE '". $DB_LINK->addq($where, get_magic_quotes_gpc()) ."%' ORDER BY ingredient_name";
