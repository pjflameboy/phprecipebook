...
?>
		...
		<ul>
			<li>
				<a href="./index.php?m=lists&amp;a=print&mode=print"><?php echo $LangUI->_('Print List'); ?></a>
			</li>
			<?php if ($SMObj->checkAccessLevel("AUTHOR")) { ?>
			<li>
				<?php echo $LangUI->_('Save to a new list'); ?> <input type="text" name="list_name">
				<input type="submit" value="<?php echo $LangUI->_('Save List'); ?>" class="button">
			</li>
			<li>
				<a href="./index.php?m=lists&amp;a=saved"><?php echo $LangUI->_('Save to an existing shopping list'); ?></a>
			</li>
		<?php }?>
		</ul>
		</form>
