...
$restaurant_id = isset($_GET['restaurant_id']) && isValidID($_GET['restaurant_id']) ? $_GET['restaurant_id'] : 0;
...
if ($restaurant_id) {
	...
	$sql = "SELECT * FROM $db_table_restaurants WHERE restaurant_id=" . $DB_LINK->addq($restaurant_id, get_magic_quotes_gpc()) . 
		" AND restaurant_user = '" . $DB_LINK->addq($SMObj->getUserID(), get_magic_quotes_gpc()) ."'";
	$rc = $DB_LINK->Execute($sql);
	DBUtils::checkResult($rc,NULL,NULL,$sql);

	$restaurant_name = $rc->fields['restaurant_name'];
	$restaurant_website = isset($rc->fields['restaurant_website']) ? $rc->fields['restaurant_website'] : '';
	$restaurant_cuisine = isset($rc->fields['restaurant_cuisine']) ? $rc->fields['restaurant_cuisine'] : '';
	$restaurant_address = isset($rc->fields['restaurant_address']) ? $rc->fields['restaurant_address'] : '';
	$restaurant_city = isset($rc->fields['restaurant_city']) ? $rc->fields['restaurant_city'] : '';
	$restaurant_state = isset($rc->fields['restaurant_state']) ? $rc->fields['restaurant_state'] : '';
	$restaurant_zip = isset($rc->fields['restaurant_zip']) ? $rc->fields['restaurant_zip'] : '';
	$restaurant_country = isset($rc->fields['restaurant_country']) ? $rc->fields['restaurant_country'] : '';
	$restaurant_phone = isset($rc->fields['restaurant_phone']) ? $rc->fields['restaurant_phone'] : '';
	$restaurant_hours = isset($rc->fields['restaurant_hours']) ? stripslashes($rc->fields['restaurant_hours']) : '';
	$restaurant_price = isset($rc->fields['restaurant_price']) ? $rc->fields['restaurant_price'] : '';
	$restaurant_delivery = isset($rc->fields['restaurant_delivery']) ? $rc->fields['restaurant_delivery'] : '';
	$restaurant_carry_out = isset($rc->fields['restaurant_carry_out']) ? $rc->fields['restaurant_carry_out'] : '';
	$restaurant_dine_in = isset($rc->fields['restaurant_dine_in']) ? $rc->fields['restaurant_dine_in'] : '';
	$restaurant_credit = isset($rc->fields['restaurant_credit']) ? $rc->fields['restaurant_credit'] : '';
	$restaurant_menu_text = isset($rc->fields['restaurant_menu_text']) ? stripslashes($rc->fields['restaurant_menu_text']) : '';
	$restaurant_comments = isset($rc->fields['restaurant_comments']) ? $rc->fields['restaurant_comments'] : '';
} else {
	$restaurant_name = "";
	$restaurant_website = "";
	$restaurant_cuisine = "";
